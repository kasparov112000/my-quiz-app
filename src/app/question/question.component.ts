import { Component, OnInit, AfterViewInit, ViewChild, Input, ElementRef, ComponentFactoryResolver } from '@angular/core';
...
import ContainerRefDirective from 'app/container-ref.directive';
